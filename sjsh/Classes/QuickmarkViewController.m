...
- (void)viewDidLoad {
    ...
    self.scanRectView.center = CGPointMake(CGRectGetWidth([UIScreen mainScreen].bounds)/2, (CGRectGetHeight([UIScreen mainScreen].bounds)-64)/2);
