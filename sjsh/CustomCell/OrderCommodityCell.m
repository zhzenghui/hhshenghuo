...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    ...
    if (self)
    {
        self.commodityImageView = [[UIImageView alloc] initWithFrame:CGRectMake(10, 0, 50, 50)];
        [self.contentView addSubview:self.commodityImageView];
 
        self.commodityContent = [[UILabel alloc] initWithFrame:CGRectMake(70, 20, 100, 15)];
         self.commodityContent.font = [UIFont systemFontOfSize:12];
        [self.contentView addSubview:self.commodityContent];
        
        self.commoditySize = [[UILabel alloc] initWithFrame:CGRectMake(70, 37, 100, 15)];
        [self.contentView addSubview:self.commoditySize];
        
        self.commodityPrice = [[UILabel alloc] initWithFrame:CGRectMake(ScreenWidth-80, 0, 70, 15)];
        ...
        self.commodityTitle = [[UILabel alloc] initWithFrame:CGRectMake(70, 0, ScreenWidth-70-70, 15)];
        self.commodityTitle.font = [UIFont systemFontOfSize:12];
        [self.contentView addSubview:self.commodityTitle];
        
        self.myStepper = [[MyStepper alloc] initWithFrame:CGRectMake(ScreenWidth-100, 20, 90, 30)];
