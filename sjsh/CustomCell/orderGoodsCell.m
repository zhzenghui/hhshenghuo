...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        reviewButton.frame = CGRectMake(215, 53, 59, 22);
        reviewButton.hidden = YES;
        [reviewButton setImage:[UIImage imageNamed:@"onceReview"] forState:UIControlStateNormal];
        reviewButton.adjustsImageWhenHighlighted = NO;
