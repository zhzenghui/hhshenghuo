...
@interface HHShoppingController : UITempletViewController<UIScrollViewDelegate, EGORefreshTableHeaderDelegate,UIScrollViewDelegate,UICollectionViewDataSource, UICollectionViewDelegateFlowLayout,UITextFieldDelegate>{
