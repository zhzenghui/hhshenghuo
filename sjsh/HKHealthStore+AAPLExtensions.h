...
- (void)aapl_mostRecentQuantitySampleOfTypeByAll:(HKQuantityType *)quantityType predicate:(NSPredicate *)predicate completion:(void (^)(NSArray *mostRecentQuantity, NSError *error))completion;
@end
